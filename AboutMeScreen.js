...
import { StyleSheet, Text, View, Linking, TouchableOpacity, ScrollView, Image } from 'react-native';
    ...
    render(){
        return (
            ...
            onContentSizeChange={(contentWidth, contentHeight)=>{  
                ...
                <Text style={styles.resumeTitle}>How About That Resume?</Text>
                    <Image source={require("./Converted.png")} style={{ height: 500, width: 350, marginLeft: "auto", marginRight: "auto", marginBottom: 50 }}  />
                {/* <Button raised title="Download Resume" buttonStyle={{ marginBottom: 50, width: 350, alignSelf: "center", backgroundColor: "#31CCC8" }} onPress={()=>alert("Sorry, site is under construction")}/> */}
            </ScrollView>
            </View>
            )
        }
